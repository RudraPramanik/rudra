    ...
    const socialMediaLinks = [
        {
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://www.linkedin.com/in/rudra-pramanik99/', '_blank'),
        },
        {
            initial: { y: 50, opacity: 0 },
            animate: inView ? { y: 0, opacity: 1 } : {},
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://www.instagram.com/rudra_himangshoo/', '_blank'),
        },
        {
            initial: { y: -50, opacity: 0 },
            animate: inView ? { y: 0, opacity: 1 } : {},
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://github.com/RudraPramanik', '_blank')
        },
        {
            initial: { y: -50, opacity: 0 },
            animate: inView ? { y: 0, opacity: 1 } : {},
        ...
        },
        {
            ...
            height: 310,
            tabIndex: 0,
            onClick: () => window.open('mailto:rudrahimangshoo2020@gmail.com', "_self")
        }
